...
item = phase2a.MediaItem(
    ...
    actor_email="debug@example.com",
    captured_by_user_id="11111111-2222-3333-4444-555555555555",
    captured_by_email="debug@example.com",
    uploaded_by_user_id="11111111-2222-3333-4444-555555555555",
    uploaded_by_email="debug@example.com",
